                ...
                <div class="col-12 col-md-10 offset-md-1">
                    <div class="slider">
                        <?php
                            $posts = get_posts( array(
                                'numberposts' => -1, // вывести все посты
                                'category_name'    => 'slider-project', // название рубрики постов
                                'orderby'     => 'date', // по дате
                                'order'       => 'ASC', // обратный порядок
                                'suppress_filters' => true, // подавление работы фильтров изменения SQL запроса
                            ) );
                            ...
                            foreach( $posts as $post ){
                                setup_postdata($post);
                                ?>
                                    <div class="slider__item"><img class="slider__img slider__img--fit-fill" data-lazy="<?php the_post_thumbnail_url(); ?>" alt="1"></div>
                                <?php
