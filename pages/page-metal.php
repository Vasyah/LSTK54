            ...
            <div class="row">
                ...
                <div class="col-md-11 offset-md-1">
                    ...
                    <ul class="promo-2nd__list">
                        ...
                        <li class="promo-2nd__item"><?php $promo_list = get_field('promo_list'); echo $promo_list['promo_list_item_4'];?></li>
                        <li class="promo-2nd__item"><?php $promo_list = get_field('promo_list'); echo $promo_list['promo_list_item_5'];?></li>
                        <li class="promo-2nd__item"><?php $promo_list = get_field('promo_list'); echo $promo_list['promo_list_item_6'];?></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-12 col-md-10 offset-md-1">
                    <div class="slider">
                        <?php
                            $posts = get_posts( array(
                                'numberposts' => -1, // вывести все посты
                                'category_name'    => 'slider-metal', // название рубрики постов
                                'orderby'     => 'date', // по дате
                                'order'       => 'ASC', // обратный порядок
                                'suppress_filters' => true, // подавление работы фильтров изменения SQL запроса
                            ) );
